...
import com.br.gabrielsilva.prismamc.commons.bukkit.hologram.touch.TouchHandler;
import com.br.gabrielsilva.prismamc.commons.bukkit.hologram.view.ViewHandler;
...
public class DefaultHologram extends CraftHologram {
	...
	private HashMap<UUID, Boolean> showns = new HashMap<>();
